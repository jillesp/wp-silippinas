...
class ET_Builder_Module_Blog_Custom extends ET_Builder_Module_Type_PostBased {
	function init() {
		$this->name       = esc_html__( 'Custom Blog', 'et_builder' );
		$this->plural     = esc_html__( 'Custom Blogs', 'et_builder' );
		$this->slug       = 'et_pb_blog_custom';
		$this->vb_support = 'on';
	...
	function get_fields() {
		$fields = array(
			...
			'__posts' => array(
				'type' => 'computed',
				'computed_callback' => array( 'ET_Builder_Module_Blog_Custom', 'get_blog_posts' ),
...
new ET_Builder_Module_Blog_Custom;
